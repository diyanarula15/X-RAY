...
/** View — the strategy horizon: which opportunity, which zone, why. The
 *  energy-validation status moved to the Energy tab, and the historical
 *  replay moved to the Replay tab's scenario walkthrough, so this view stays
 *  about one thing: the call, and the per-lap detail behind it. */
export function Strategy({ raceId, car, rival }:
  ...
  return (
    <div style={{ padding: '26px 34px', height: '100%', overflow: 'auto' }}>
      <h2 className="display" style={{ fontSize: 26, margin: 0 }}>Strategy horizon</h2>
      ...
      {p2 && (
        <div className="panel" style={{ padding: 15, marginTop: 12 }}>
          <div style={{ color: C.gray, fontSize: 10.5, letterSpacing: '0.09em',
                        fontWeight: 700, marginBottom: 9 }}>OPPORTUNITY HORIZON</div>
